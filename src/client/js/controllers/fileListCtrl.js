(function () {
	angular.module('nodeVlcCtrlr').controller('FileListCtrl',
		['$rootScope', '$scope', '$timeout', 'filesFactory', 'localStorageFactory', function ($rootScope, $scope, $timeout, filesFactory, localStorageFactory) {
